...
int32_t main(int32_t argc, char **argv) {
    ...
    if ( (0 == commandlineArguments.count("cid")) ||
        ...
        if (sharedMemory && sharedMemory->valid()) {
            ...
            auto onGroundSteeringRequest = [&gsr, &gsrMutex,&grndSteerAngle](cluon::data::Envelope &&env){
               ...
               // std::cout<< "group_06;"<< env.sampleTimeStamp().seconds()<<"."<< env.sampleTimeStamp().microseconds()<<
                //";"<<grndSteerAngle<<std::endl;
            };
            ...
            auto onDistanceReadingRequest=[&dr, &drMutex, &dis,&time,&sec](cluon::data::Envelope &&env){
            ...
            while (od4.isRunning()) {
                ...
                cluon::data::TimeStamp tid= sharedMemory->getTimeStamp().second;
                int64_t microsecond= cluon::time::toMicroseconds(tid);
                ...
                else if(contoursB.size()>0 && contoursY.size() > 0){ 
                ...
                std::cout <<"group_06;"<<microsecond<<";"<<grndSteerAngle<<std::endl;
                ...
                if (VERBOSE) {
                    ...
                    cv::imshow("triangle", drawing);
                    cv::imshow("warped image", warpedImgCombined);
